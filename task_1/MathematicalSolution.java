    ...
    public static void main(String[] args) {
        ...
        switch (userDoubleOrInt) {
            case ("Int"):
                ...
                switch (userWhatToDo) {
                    case ("Вычитание"):
                        System.out.printf("Результат разности между %s и %s = %s", a, b);
                        break;
                    case ("Сложение"):
                        System.out.printf("Результат сложения между %s и %s = %s", a, b );
                        break;
                    case ("Умножение"):
                        System.out.printf("Результат умножения между %s и %s = %s", a, b );
                        break;
                    case ("Деление"):
                        System.out.printf("Результат деления между %s и %s = %s", a, b );
                        break;
                    case ("Взять процент от числа"):
                        System.out.printf("Результат взятия процента между %s и %s = %s", a, b );
                        break;
                    default:
            ...
            case ("Double"):
                ...
                switch (userWhatdoD) {
                    case ("Вычитание"):
                        System.out.printf("Результат разности между %s и %s = %s", ad, bd);
                        break;
                    case ("Сложение"):
                        System.out.printf("Результат сложения между %s и %s = %s", ad, bd);
                        break;
                    case ("Умножение"):
                        System.out.printf("Результат умножения между %s и %s = %s", ad, bd);
                        break;
                    case ("Деление"):
                        System.out.printf("Результат деления между %s и %s = %s", ad, bd);
                        break;
                    case ("Взять процент от числа"):
